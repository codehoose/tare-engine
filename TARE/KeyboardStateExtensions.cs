...
namespace TARE
{
    internal static class KeyboardStateExtensions
    {
        ...
        /// From https://roy-t.nl/2010/02/11/code-snippet-converting-keyboard-input-to-text-in-xna
        /// </summary>
        ...
        public static bool TryConvertKeyboardInput(this KeyboardState keyboard, KeyboardState oldKeyboard, out char key)
        {
